...
public class ClawConstants {
    ...
    public static ClawState REST_STATE = new ClawState(CLAW_CLOSE_POSITION, 1.0, 0.7, 1.0);
    ...
    // SPECIMEN POSITIONS
    public static ClawState SPECIMEN_COLLECT_STATE = new ClawState(CLAW_OPEN_POSITION, 0.95, 0.42, 1.0);
