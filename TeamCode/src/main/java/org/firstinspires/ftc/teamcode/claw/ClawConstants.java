...
public class ClawConstants {
    ...
    public static ClawState REST_STATE = new ClawState(1.0, 1.0, 0.95, 0.9);

    // SAMPLE POSITIONS
    public static double SAMPLE_COLLECT_JOINT_ONE_POS = 0.2;
    public static double SAMPLE_COLLECT_JOINT_TWO_POS = 0.7;

    public static ClawState SAMPLE_COLLECTING_STATE = new ClawState(0.0, 1.0, 0.55, 0.18);
    public static ClawState SAMPLE_SCORING_STATE = new ClawState(1.0, 1.0, 0.5, 0.2);

    // SPECIMEN POSITIONS
    public static ClawState SPECIMEN_COLLECT_STATE = new ClawState(0.0, 1.0, 0.4, 1.0);
